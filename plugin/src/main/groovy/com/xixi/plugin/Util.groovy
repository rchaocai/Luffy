    ...
    public static void initTargetClasses(Map<String, Object> modifyMatchMaps) {
        ...
        if (modifyMatchMaps != null) {
            ...
            for (Map.Entry<String, Object> entry : set) {
                ...
                Log.info "==============value ${value.toString() + ''}transform enter=============="
//                if (value) {
                    int type;
                    ...
                    Log.info "==============key ${entry.getKey().toString()}transform enter=============="
                    Log.info "==============key ${type + ''}transform enter=============="
...
//                }
    ...
    public static boolean isTargetClassesNotEmpty() {
        boolean isTarget = targetClasses != null && targetClasses.size() > 0
        Log.info "==============hiBeaver ${isTarget.toString() + ' '}transform enter=============="
